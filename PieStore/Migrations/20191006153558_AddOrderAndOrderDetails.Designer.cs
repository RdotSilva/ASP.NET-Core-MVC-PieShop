...
namespace PieStore.Migrations
{
    ...
    [Migration("20191006153558_AddOrderAndOrderDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PieStore.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("PieStore.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("PieStore.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("PieStore.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("PieStore.Models.OrderDetail", b =>
                {
                    b.HasOne("PieStore.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PieStore.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PieStore.Models.Pie", b =>
                {
                    b.HasOne("PieStore.Models.Category", "Category")
                        .WithMany("Pies")
